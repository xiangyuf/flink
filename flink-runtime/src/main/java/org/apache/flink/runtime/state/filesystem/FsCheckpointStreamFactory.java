...
public class FsCheckpointStreamFactory implements CheckpointStreamFactory {
    ...
    private final FsCheckpointStorageAccess.CheckpointWriteFileStatistic currentPeriodStatistic;
     ...
     *     rather than in files
     * @param writeBufferSize The write buffer size.
     * @param currentPeriodStatistic The statistic for file write.
     */
    public FsCheckpointStreamFactory(
            FileSystem fileSystem,
            Path checkpointDirectory,
            ...
            int fileStateSizeThreshold,
            int writeBufferSize,
            FsCheckpointStorageAccess.CheckpointWriteFileStatistic currentPeriodStatistic) {
    ...
    public static class FsCheckpointStateOutputStream extends CheckpointStateOutputStream {
        ...
        private void updateWriteStatistic(long writeBytes, long writeLatency, boolean force) {
            ...
            if (this.writeBytes >= MIN_WRITE_BYTES_TO_REPORT || force) {
                this.currentPeriodStatistic.updateWriteStatistics(
