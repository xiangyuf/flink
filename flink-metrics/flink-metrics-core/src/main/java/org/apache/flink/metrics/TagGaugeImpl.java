...
/** Gauge with tags. */
public class TagGaugeImpl implements TagGauge, Gauge<TagGaugeStore> {
    private static final Logger LOG = LoggerFactory.getLogger(TagGaugeImpl.class);
    ...
    public static class TagGaugeBuilder {
        ...
        public TagGaugeImpl build() {
            return new TagGaugeImpl(size, clearAfterReport, clearWhenFull, metricsReduceType);
        }
    }
}
